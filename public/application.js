...
/***/ (function(module, exports, __webpack_require__) {
	...
	var profileEvents = __webpack_require__(14);
	var concertEvents = __webpack_require__(16);
	var myConcertEvents = __webpack_require__(39);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://salty-shore-97321.herokuapp.com/'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var config = __webpack_require__(6);
	var store = __webpack_require__(10);
	var myconcerts = __webpack_require__(13);
	...
	var destroy = function destroy(profileID) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var destroy = function destroy(myConcertID) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onGetProfile = function onGetProfile(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.show(data).then(ui.onGetProfileSuccess).catch(ui.onGetProfileFailure);
	};

	var onCreateProfile = function onCreateProfile(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.create(data).then(ui.onCreateProfileSuccess).catch(ui.onCreateProfileFailure);
	};

	var onUpdateProfile = function onUpdateProfile(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.update(data, store.profile.id).then(ui.onUpdateProfileSuccess).catch(ui.onUpdateProfileFailure);
	};

	var onDeleteProfile = function onDeleteProfile(event) {
	  event.preventDefault();
	  api.destroy(store.profile.id).then(ui.onDestroyProfileSuccess).catch(ui.onDestroyProfileFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var profileEngine = __webpack_require__(10);

	var onGetProfileSuccess = function onGetProfileSuccess(response) {};

	var onGetProfileFailure = function onGetProfileFailure(error) {
	  $('div#statusBar').text('Get profile failed. Status = ' + error.status + ' ' + error.statusText);
	  $('div#statusBar').show(3000);
	  $('div#statusBar').hide(5000);
	};

	var onUpdateProfileSuccess = function onUpdateProfileSuccess(response) {
	  // $('#show-my-profiles-btn').click()
	  $('#update-profile-close').click();
	  // $('#show-my-profiles-btn').click()
	};

	var onUpdateProfileFailure = function onUpdateProfileFailure(error) {
	...
	var onCreateProfileFailure = function onCreateProfileFailure(error) {
	  $('#create-profile-close').click();
	...
	var onDestroyProfileSuccess = function onDestroyProfileSuccess() {
	  // $('#show-my-profiles-btn').click()
	};

	var onDestroyProfileFailure = function onDestroyProfileFailure(error) {
	...
	module.exports = {
	  onGetProfileSuccess: onGetProfileSuccess,
	  onGetProfileFailure: onGetProfileFailure,
	  onUpdateProfileSuccess: onUpdateProfileSuccess,
	  onUpdateProfileFailure: onUpdateProfileFailure,
	  onCreateProfileSuccess: onCreateProfileSuccess,
	  onCreateProfileFailure: onCreateProfileFailure,
	  onDestroyProfileSuccess: onDestroyProfileSuccess,
	  onDestroyProfileFailure: onDestroyProfileFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onGetConcerts = function onGetConcerts(event) {
	  event.preventDefault();
	  api.index().then(ui.onGetConcertsSuccess).catch(ui.onGetConcertsFailure);
	};

	var onFilterConcerts = function onFilterConcerts(event) {
	  event.preventDefault();
	  var data = $('#filter-concerts-form').find('.filterText').val();
	  ui.displayMatches(data);

	  $('.app-header').text('All Concerts - filtered by - ' + data);

	  $('#filter-concerts-form').trigger('reset').catch(ui.onFilterConcertsFailure);
	};
	...
	module.exports = {
	  addHandlers: addHandlers,
	  onGetConcerts: onGetConcerts,
	  onFilterConcerts: onFilterConcerts
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var concertEngine = __webpack_require__(10);

	var showConcertsTemplate = __webpack_require__(19);

	var onGetConcertsSuccess = function onGetConcertsSuccess() {
	  var savedConcerts = setSavedConcerts(concertEngine.concerts);

	  $('.concert-rows').empty();

	  var showConcertsHtml = showConcertsTemplate({ concerts: savedConcerts });
	...
	var onGetConcertsFailure = function onGetConcertsFailure(error) {
	  $('div#statusBar').text('Get concerts failed. Status = ' + error.status + ' ' + error.statusText);
	  $('div#statusBar').show(3000);
	  $('div#statusBar').hide(5000);
	};

	var onFilterConcertsFailure = function onFilterConcertsFailure(error) {
	...
	function setSavedConcerts(concertArray) {
	  var saveConcertsArray = concertArray;
	  for (var c = 0; c < saveConcertsArray.length; c++) {
	    if (concertEngine.myconcerts && concertEngine.myconcerts.length > 0) {
	      for (var m = 0; m < concertEngine.myconcerts.length; m++) {
	...
	var findMatches = function findMatches(wordToMatch) {
	  var filteredConcerts = concertEngine.concerts.filter(function (concert) {
	    // here we need to figure out if the city or state matches what was searched
	    var regex = new RegExp(wordToMatch, 'gi');
	    var name = concert.concert_name ? concert.concert_name : '';
	    var addr = concert.venue_address ? concert.venue_address : '';
	    return name.match(regex) || concert.concert_date.match(regex) || concert.artist.match(regex) || concert.venue.match(regex) || addr.match(regex) || concert.cost.match(regex);
	  });
	  return filteredConcerts;
	};

	function displayMatches(filterText) {
	  var matchArray = findMatches(filterText);
	  var savedMatchArray = setSavedConcerts(matchArray);
	  $('.concert-rows').empty();
	  var showConcertsHtml = showConcertsTemplate({ concerts: savedMatchArray });
	  $('.concert-rows').append(showConcertsHtml);
	}

	module.exports = {
	  onGetConcertsSuccess: onGetConcertsSuccess,
	  onGetConcertsFailure: onGetConcertsFailure,
	  displayMatches: displayMatches,
	  onFilterConcertsFailure: onFilterConcertsFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <tr data-id=\""
	    ...
	    + "\">\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.saved : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "    <td class='cname'>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.concert_name : stack1), depth0))
	    + "</td>\n    <td class='cdate'>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.concert_date : stack1), depth0))
	    + "</td>\n    <td class='ctime'>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.concert_time : stack1), depth0))
	    + "</td>\n    <td class='cartist'>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.artist : stack1), depth0))
	    + "</td>\n    <td class='cvenue'>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.venue : stack1), depth0))
	    + "</td>\n    <td class='caddress'>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.venue_address : stack1), depth0))
	    + "</td>\n    <td class='ccost'>"
	  ...
	  return "      <td data-id=\""
	    ...
	    + "\"><button id=\"saveConcert\" class=\"btn btn-default saveConcert disabled\" data-target=\"#saveConcert\">Saved</button></td>\n      </td>\n";
	},"4":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "      <td data-id=\""
	    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><button id=\"saveConcert\" class=\"btn btn-default saveConcert\" data-target=\"#saveConcert\">Save</button></td>\n      </td>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.concerts : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onSaveConcert = function onSaveConcert(event) {
	  event.preventDefault();
	  var concertID = event.currentTarget.parentNode.getAttribute('data-id');
	  event.currentTarget.disabled = true;
	  event.currentTarget.textContent = 'Saved';
	  var profileID = store.profile.id;
	  var data = {
	    'myconcert': {
	    ...
	    // const data = getFormFields(event.target)
	  };api.create(data).then(ui.onCreateMyConcertSuccess).catch(ui.onCreateMyConcertFailure);
	};

	var onGetMyConcerts = function onGetMyConcerts(event) {
	  event.preventDefault();
	  api.index().then(ui.onGetMyConcertsSuccess).catch(ui.onGetMyConcertsFailure);
	};

	var onDeleteMyConcert = function onDeleteMyConcert(event) {
	  event.preventDefault();
	  var concertID = event.currentTarget.parentNode.getAttribute('data-id');
	  api.destroy(concertID).then(ui.onDestroyMyConcertSuccess).catch(ui.onDestroyMyConcertFailure);
	};
	...
	module.exports = {
	  addHandlers: addHandlers,
	  onGetMyConcerts: onGetMyConcerts,
	  onSaveConcert: onSaveConcert
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showConcertsTemplate = __webpack_require__(41);

	var concertEngine = __webpack_require__(10);

	var onGetMyConcertsSuccess = function onGetMyConcertsSuccess() {
	  $('#filter-concerts-form').hide();
	  $('.concert-rows').empty();

	  var showConcertsHtml = showConcertsTemplate({ myconcerts: concertEngine.myconcerts });
	  $('.concert-rows').append(showConcertsHtml);
	...
	var onGetMyConcertsFailure = function onGetMyConcertsFailure(error) {
	  $('div#statusBar').text('Get concerts failed. Status = ' + error.status + ' ' + error.statusText);
	  $('div#statusBar').show(3000);
	  $('div#statusBar').hide(5000);
	};

	var onCreateMyConcertSuccess = function onCreateMyConcertSuccess() {
	...
	var onCreateMyConcertFailure = function onCreateMyConcertFailure(error) {
	  $('div#statusBar').text('Add concert failed. Status = ' + error.status + ' ' + error.statusText);
	  $('div#statusBar').show(3000);
	  $('div#statusBar').hide(5000);
	};

	var onDestroyMyConcertSuccess = function onDestroyMyConcertSuccess() {
	  $('#show-my-concerts-btn').click();
	};

	var onDestroyMyConcertFailure = function onDestroyMyConcertFailure(error) {
	...
	module.exports = {
	  onGetMyConcertsSuccess: onGetMyConcertsSuccess,
	  onGetMyConcertsFailure: onGetMyConcertsFailure,
	  onCreateMyConcertSuccess: onCreateMyConcertSuccess,
	  onCreateMyConcertFailure: onCreateMyConcertFailure,
	  onDestroyMyConcertSuccess: onDestroyMyConcertSuccess,
	  onDestroyMyConcertFailure: onDestroyMyConcertFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <tr data-id=\""
	    ...
	    + "\">\n    <td data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><button id=\"deleteConcert\" class=\"btn btn-default deleteConcert\" data-target=\"#deleteConcert\">Delete From My List</button></td>\n    <td class='cname'>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.concert : depth0)) != null ? stack1.concert_name : stack1), depth0))
	    + "</td>\n    <td class='cdate'>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.concert : depth0)) != null ? stack1.concert_date : stack1), depth0))
	    + "</td>\n    <td class='ctime'>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.concert : depth0)) != null ? stack1.concert_time : stack1), depth0))
	    + "</td>\n    <td class='cartist'>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.concert : depth0)) != null ? stack1.artist : stack1), depth0))
	    + "</td>\n    <td class='cvenue'>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.concert : depth0)) != null ? stack1.venue : stack1), depth0))
	    + "</td>\n    <td class='caddress'>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.concert : depth0)) != null ? stack1.venue_address : stack1), depth0))
	    + "</td>\n    <td class='ccost'>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.concert : depth0)) != null ? stack1.cost : stack1), depth0))
	    + "</td>\n  </tr>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.myconcerts : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "6492abd3957771d1bc97b44d4f82ae65.jpg";
